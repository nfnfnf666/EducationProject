        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="toolbarDemo">
                <div class="layui-btn-container">
                    ...
                    <button type="button" onclick="insertVideo()" class="layui-btn layui-btn-sm">新增</button>
                </div>
            </script>
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                parent.layer.open({   //打开一个弹出层
                    ...
                    maxmin: true,
                    type: 2,
                    content: 'playVideo.do?coursewareId='+data.coursewareId, //要访问的地址
                    area: ['730px', '470px'],
...
<script>
    ...
    function insertVideo() {
        parent.layer.open({   //打开一个弹出层
            ...
            maxmin: true,
            type: 2,
            content: 'teacher/insertVideo.jsp', //要访问的地址
            area: ['500px', '450px'],
