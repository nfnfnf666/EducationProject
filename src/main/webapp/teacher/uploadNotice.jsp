...
<form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="noticeTitle" lay-verify="required" value="${notice.noticeTitle}" placeholder="请输入公告标题" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">公告内容</label>
        <div class="layui-input-inline">
            <textarea type="text" name="noticeContent" lay-verify="required" placeholder="请输入公告内容" autocomplete="off" class="layui-textarea">${notice.noticeContent}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit(LAY-user-front-submit)', function(data){
            $.ajax({
                url: "${pageContext.request.contextPath}/updateNotice.do",
                datatype: "json",
                type: 'post',
