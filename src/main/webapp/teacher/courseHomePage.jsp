    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <cite><img src="${pageContext.request.contextPath}/image/${teacher.teacherImg}" class="layui-nav-img">${teacher.teacherName}</cite>
                    </a>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        <a href="javascript:;" lay-href="teacher/notice.jsp" lay-tips="公告管理" lay-direction="2">
                    ...
                    <li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="课件管理" lay-direction="2">
                            <i class="layui-icon layui-icon-app"></i>
                            <cite>课件管理</cite>
                        </a>
                        <dl class="layui-nav-child">
                            <dd><a lay-href="teacher/videoList.jsp">教学视频</a></dd>
                            <dd><a lay-href="teacher/documentList.jsp">文档资源</a></dd>
                        </dl>
                    </li>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="teacher/notice.jsp" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
