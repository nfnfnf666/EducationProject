        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <script type="text/html" template>
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="cellphone" id="LAY-user-login-cellphone" lay-verify="phone" placeholder="请输入您预留的手机号" class="layui-input">
                </div>
                <div class="layui-form-item">
                    <div class="layui-row">
            ...
            admin.req({
                ...
                ,done: function(res){
                    layer.msg('密码已成功重置', {
                        ...
                        location.href = 'user/login.jsp'; //跳转到登入页
                    });
                }
            });
