    ...
    layui.use(['table','jquery','layer','form'], function(){
        ...
        var d=table.render({
            ...
            ,cols: [[
                ...
                ,{field:'courseId', title: '课程编号', sort: true, fixed: 'left', width: '200'}
                ,{field:'courseName', title: '课程名称', width: '200'}
                ,{field:'courseDesc', title: '课程描述', width: '640'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确定要删除吗？', {  //打开一个询问框
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/delCourse.do",
                        datatype:"json",
                ...
                parent.layer.open({   //打开一个弹出层
                    ...
                    maxmin: true,
                    type: 2,
                    content: 'uploadCourse.do?courseId='+data.courseId, //要访问的地址
                    area: ['550px', '400px'],
...
<script>
    ...
    function insertCourse() {
        parent.layer.open({   //打开一个弹出层
            ...
            maxmin: true,
            type: 2,
            content: 'admin/insertCourse.jsp', //要访问的地址
            area: ['500px', '450px'],
