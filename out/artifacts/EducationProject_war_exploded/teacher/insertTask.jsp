...
<form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="taskTitle" lay-verify="required" placeholder="请输入作业标题" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">作业内容</label>
        <div class="layui-input-inline">
            <textarea type="text" name="taskContent" lay-verify="required" placeholder="请输入作业内容" autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit(LAY-user-front-submit)', function(data){
            $.ajax({
                url: "${pageContext.request.contextPath}/insertTask.do",
                datatype: "json",
                type: 'post',
