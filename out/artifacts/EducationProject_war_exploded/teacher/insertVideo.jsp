...
<form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="coursewareUrl" placeholder="请上传视频课件" autocomplete="off" class="layui-input" >
        </div>
...
<script>
    layui.config({
        ...
        upload.render({
            ...
            ,url: '${pageContext.request.contextPath}/uploadVideo.do'
            ,accept: 'video'
            ,method: 'get'
            ,acceptMime: 'video/*'
            ,done: function(res){
        ...
        form.on('submit(LAY-user-front-submit)', function(data){
            $.ajax({
                url: "${pageContext.request.contextPath}/insertVideo.do",
                datatype: "json",
                type: 'post',
