    ...
    layui.use(['table','jquery','layer','form'], function(){
        ...
        var d=table.render({
            ...
            ,cols: [[
                ...
                ,{field:'topicId', title: '帖子编号', sort: true, fixed: 'left'}
                ,{field:'publisherId', title: '发布人编号', sort: true}
                ,{field:'topicTitle', title: '帖子标题'}
                ,{field:'topicContent', title: '帖子内容'}
                ,{field:'topicPublishedTime', title: '发布时间'}
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                table.reload('testReload', {
                    ...
                    ,where: {
                        topic_id: demoReload.val(),
                        topic_title:demoReload1.val(),
                        topic_content:demoReload2.val()
                    }
                });
            }
        };
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确定要删除吗？', {  //打开一个询问框
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/delTopic.do",
                        datatype:"json",
                ...
                parent.layer.open({   //打开一个弹出层
                    ...
                    maxmin: true,
                    type: 2,
                    content: 'uploadTopic.do?topicId='+data.topicId, //要访问的地址
                    area: ['550px', '400px'],
