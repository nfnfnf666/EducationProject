        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="toolbarDemo">
                <div class="layui-btn-container">
                    ...
                    <button type="button" onclick="insertStudent()" class="layui-btn layui-btn-sm">新增</button>
                </div>
            </script>
    ...
    layui.use(['table','jquery','layer','form'], function(){
        ...
        var d=table.render({
            ...
            ,cols: [[
                ...
                ,{field:'studentName', title:'姓名', edit: 'text'}
                ,{field:'studentImg', title:'学生头像', templet:'<div><img src="${pageContext.request.contextPath}/image/{{d.studentImg}}" width="30" height="30"/></div>'}
                ,{field:'studentSex', title:'性别'}
                ,{field:'studentPwd', title:'密码'}
                ,{field:'classId', title:'所在班级'}
            ...
            switch(obj.event){
                ...
                case 'delSum': {
                    ...
                    layer.confirm('您确定要删除选中数据吗？', function (index) {
                        layer.close(index);
                        $.ajax({
                            url: "${pageContext.request.contextPath}/delStudents.do",
                            dataType: "json",
                            data: {ids: ids},
                            type: "GET",
                            parseData: function(res){ //res 即为原始返回的数据
                ...
                case 'downloadExcel':
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/downloadExcel.do",
                        dataType: "json",
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                table.reload('testReload', {
                    ...
                    ,where: {
                        student_id: demoReload.val(),
                        student_name:demoReload1.val()
                    }
                });
            }
        };
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确定要删除吗？', {  //打开一个询问框
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/delStudent.do",
                        datatype:"json",
                ...
                parent.layer.open({   //打开一个弹出层
                    ...
                    maxmin: true,
                    type: 2,
                    content: 'uploadStudent.do?studentId='+data.studentId, //要访问的地址
                    area: ['550px', '400px'],
...
<script>
    ...
    function insertStudent() {
        parent.layer.open({   //打开一个弹出层
            ...
            maxmin: true,
            type: 2,
            content: 'admin/insertStudent.jsp', //要访问的地址
            area: ['600px', '450px'],
    ...
    layui.use(['element','upload'], function(){
        ...
        var uploadInst = upload.render({
            elem: '#test1'
            ,url: "${pageContext.request.contextPath}/uploadExcel.do"
            ,accept: 'file' //普通文件
            ,exts:'xls|xlsx'
            ,method:"POST"
            ,parseData: function(res){ //res 即为原始返回的数据
