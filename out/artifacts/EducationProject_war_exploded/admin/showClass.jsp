        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="toolbarDemo">
                <div class="layui-btn-container">
                    ...
                    <button type="button" onclick="insertClass()" class="layui-btn layui-btn-sm">新增</button>
                </div>
            </script>
    ...
    layui.use(['table','jquery','layer','form'], function(){
        ...
        var d=table.render({
            ...
            ,cols: [[
                ...
                ,{field:'classId', title: '班级编号', sort: true, fixed: 'left', width: '200'}
                ,{field:'className', title: '班级名称', width: '200'}
                ,{field:'classDesc', title: '班级描述', width: '640'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确定要删除吗？', {  //打开一个询问框
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/delClass.do",
                        datatype:"json",
                ...
                parent.layer.open({   //打开一个弹出层
                    ...
                    maxmin: true,
                    type: 2,
                    content: 'uploadClass.do?classId='+data.classId, //要访问的地址
                    area: ['550px', '400px'],
...
<script>
    ...
    function insertClass() {
        parent.layer.open({   //打开一个弹出层
            ...
            maxmin: true,
            type: 2,
            content: 'admin/insertClass.jsp', //要访问的地址
            area: ['500px', '450px'],
